...
human_length1(L) when L > 1024 * 1024 * 1024 ->
    io_lib:format("~.2f GB", [L / (1024 * 1024 * 1024)]);

human_length1(L) when L > 1024 * 1024 ->
    io_lib:format("~.2f MB", [L / (1024 * 1024)]);

human_length1(L) when L > 1024 ->
    io_lib:format("~.2f KB", [L / 1024]);
...
human_duration1(D) when D >= 60 * 60->
    io_lib:format("~Bh ago", [D div (60 * 60)]);

human_duration1(D) when D >= 60 ->
    io_lib:format("~Bm ago", [D div 60]);

human_duration1(D) ->
    io_lib:format("~Bs ago", [D]).
